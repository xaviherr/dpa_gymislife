...
import xherrera.esan.dpa_gym_is_life.data.entities.CuentaModel
...
class CustomerRegisterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_customer_register, container, false)
                                            ...
                                            db.collection("registro")
                                                ...
                                                .addOnSuccessListener {
                                                    ...
                                                    findNavController().navigate(
                                                        CustomerRegisterFragmentDirections
                                                            .actionCustomerRegisterFragmentToLoginFragment())
                                                }
                                        }
